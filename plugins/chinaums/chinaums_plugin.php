...
class chinaums_plugin
{
	...
	static private function qrcode(){
		...
		$goods = array(array(
		    ...
		    'goodsName'=>'宝贝盒子',
		    'quantity'=>1,
		    'subMerchantId'=>'2088950453885623',
		    'merOrderId'=>TRADE_NO
		    ));
		$param = [
        ...
        file_put_contents('pochums.txt',json_encode($param));
	...
	static public function notify(){
        ...
        file_put_contents('chums.txt',json_encode($_POST).PHP_EOL,FILE_APPEND);
		require(PAY_ROOT."inc/Build.class.php");
