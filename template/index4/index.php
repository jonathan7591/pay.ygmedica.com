      ...
      <div class="row align-items-center justify-content-xl-between">
        <div class="col-xl-6">
          <div class="copyright text-center text-xl-left text-muted">
            <?php echo $conf['sitename']?>&nbsp;&nbsp;&copy;&nbsp;<?php echo date("Y")?>&nbsp;All Rights Reserved.</br>
             <a href="https://beian.miit.gov.cn/#/Integrated/index">苏ICP备2024137517号-1</a></br>
            <a href="https://rose.pcac.org.cn/platform/publicInfo/recordPublic">中国支付清算协会备案号:W2021320100000188</a>
          </div>
        </div>
        <div class="col-xl-6">
